...
(function() {
    ...
    /* Un icono único por habilidad (sin repeticiones). Font Awesome 5/6 free. */
    var habilidadIconMap = {
        'Autogestión': 'fa-user-check', 'Proactividad': 'fa-rocket', 'Integridad': 'fa-shield-check',
        'Empatía': 'fa-heart', 'Autoconocimiento': 'fa-user-circle', 'Autorregulación': 'fa-balance-scale',
        ...
        'Toma de decisiones': 'fa-check-circle', 'Pensamiento crítico': 'fa-lightbulb', 'Asertividad': 'fa-comment-dots',
        'Comunicación efectiva': 'fa-bullhorn', 'Marca personal': 'fa-user-tag', 'Redacción y ortografía': 'fa-pen',
        'Protocolo y etiqueta empresarial': 'fa-user-tie', 'Hablar en público': 'fa-microphone', 'Gestión de stakeholders': 'fa-users-cog',
        'Gestión del tiempo': 'fa-clock', 'Planificación': 'fa-calendar-check', 'Organización': 'fa-folder-open',
        'Orientación a la mejora continua': 'fa-arrow-circle-up', 'Pensamiento sistémico': 'fa-project-diagram', 'Adaptabilidad': 'fa-sync',
        'Aprendizaje continuo': 'fa-graduation-cap', 'Persuasión': 'fa-comments-dollar', 'Generación de acuerdos': 'fa-file-signature',
        'Salud mental y emocional': 'fa-heart-pulse', 'Salud física': 'fa-person-running', 'Balance de vida': 'fa-spa',
        'Alimentación saludable': 'fa-apple-alt', 'Salud financiera': 'fa-wallet', 'Empoderamiento': 'fa-crown',
        'Motivación': 'fa-fire', 'Pensamiento estratégico': 'fa-chess', 'Coaching de equipos': 'fa-chalkboard-user',
        'Grammar': 'fa-book', 'Listening': 'fa-headphones', 'Reading': 'fa-book-open', 'Speaking': 'fa-microphone-lines',
        'Writing': 'fa-pen-fancy', 'Vocabulary': 'fa-book-reader', 'Creatividad': 'fa-palette', 'Pensamiento disruptivo': 'fa-bolt',
        'Ideación': 'fa-lightbulb-on', 'Pensamiento exponencial': 'fa-chart-area', 'Servicio al cliente': 'fa-headset',
        'Manejo de objeciones': 'fa-comments', 'Customer Relationship Management (CRM)': 'fa-address-book',
        'Diseño de la experiencia de cliente (CX)': 'fa-smile', 'Branding': 'fa-tag', 'Storytelling': 'fa-book-open-reader', 'Social media': 'fa-share-alt',
        'Prospección': 'fa-search', 'Gestión de ciclo de ventas': 'fa-arrows-rotate', 'Cierre de ventas': 'fa-hand-holding-dollar',
        'Venta consultiva': 'fa-hand-holding-dollar', 'Gestión del equipo comercial': 'fa-user-group', 'Agilidad de negocios': 'fa-tachometer-alt',
        'Metodologías ágiles': 'fa-sitemap', 'Cultura organizacional': 'fa-building', 'Adquisición del talento': 'fa-user-plus',
        'Experiencia del empleado (EX)': 'fa-user-pen', 'Relaciones laborales': 'fa-briefcase', 'Analítica de personas': 'fa-chart-bar',
        'Diversidad, equidad e inclusión': 'fa-people-group', 'Gestión del desempeño': 'fa-sliders', 'Desarrollo del talento': 'fa-user-graduate',
        'Teletrabajo': 'fa-laptop', 'Planeación de proyectos': 'fa-calendar-days', 'Control de proyectos': 'fa-list-check',
        ...
        'Control financiero': 'fa-sack-dollar', 'Financial services': 'fa-university', 'Estrategia': 'fa-chess-knight', 'Control de gestión': 'fa-clipboard-check',
        'Análisis económico': 'fa-coins', 'Sostenibilidad y RSE': 'fa-leaf',         'Propuesta de valor': 'fa-gem',
        'Modelos de negocio': 'fa-cube', 'Intraemprendimiento': 'fa-plane-up', 'Riesgo operativo': 'fa-exclamation-triangle',
        'Continuidad del negocio': 'fa-shield-halved', 'Cumplimiento en Data & IT': 'fa-database', 'Cumplimiento financiero': 'fa-file-invoice',
        'Gobierno corporativo': 'fa-building-columns', 'Sistemas de gestión HSEQ +RL': 'fa-clipboard-list', 'Cumplimiento operativo y de calidad': 'fa-circle-check',
        'Legislación laboral': 'fa-gavel', 'Administración de bases de datos': 'fa-table-cells', 'Análisis de datos': 'fa-chart-column',
        'Visualización de datos': 'fa-chart-pie', 'Inteligencia de negocios (BI)': 'fa-brain', 'Big data': 'fa-layer-group',
        'Probabilidad y estadística': 'fa-square-root-variable', 'Design thinking': 'fa-wand-magic-sparkles', 'Diseño UX': 'fa-mouse-pointer',
        'Diseño UI': 'fa-paintbrush', 'Prototipado': 'fa-drafting-compass', 'UX Research': 'fa-magnifying-glass', 'Software testing': 'fa-vial',
        'DevOps': 'fa-code-branch', 'Herramientas de desarrollo de software': 'fa-screwdriver-wrench', 'Herramientas No Code': 'fa-magic',
        'Pensamiento computacional': 'fa-microchip', 'SQL': 'fa-database', 'Java': 'fa-coffee', 'JavaScript': 'fa-code', 'PHP': 'fa-file-code',
        'Python': 'fa-terminal', 'NoSQL': 'fa-table', 'Ruby': 'fa-gem', 'R': 'fa-chart-scatter', 'C Sharp (C#)': 'fa-brackets-curly',
        'Desarrollo frontend': 'fa-laptop-code', 'Desarrollo backend': 'fa-server', 'Diseño e implementación de APIs': 'fa-plug',
        'Aplicaciones Microsoft': 'fa-windows', 'Aplicaciones Google': 'fa-globe', 'Herramientas para proyectos': 'fa-diagram-project',
        'Herramientas colaborativas': 'fa-people-line', 'Herramientas de diseño': 'fa-brush', 'Herramientas de ventas': 'fa-tags',
        'Aplicaciones Amazon': 'fa-box', 'Sistema Linux': 'fa-terminal', 'Computadores, dispositivos electrónicos e internet': 'fa-desktop',
        'Diseño gráfico digital': 'fa-paint-brush', 'Tendencias digitales': 'fa-trending-up', 'Contenido digital': 'fa-file-lines',
        'Transformación digital': 'fa-right-left', 'Arquitectura TI': 'fa-network-wired', 'Infraestructura tecnológica': 'fa-hard-drive',
        'Ciberseguridad': 'fa-shield-virus', 'Derecho digital': 'fa-scale-balanced', 'Gestión de plataformas de e-commerce': 'fa-cart-shopping',
        'Product marketing': 'fa-bullhorn', 'Analítica en marketing': 'fa-chart-mixed', 'Gestión del funnel de conversión': 'fa-filter',
        'Growth marketing': 'fa-arrow-trend-up', 'Google Analytics': 'fa-chart-simple', 'Google Ads': 'fa-rectangle-ad', 'Inbound marketing': 'fa-arrow-down'
    };
