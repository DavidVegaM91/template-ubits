...
var DOCS_SIDEBAR_SECTIONS = [
    ...
    { id: 'indice-progreso-estudiante', title: 'Indice Progreso Estudiante', group: 'aprendizaje' },
    ...
    { id: 'paginas-progreso-estudiante', title: 'Paginas Progreso Estudiante', group: 'aprendizaje' },
    ...
    { id: 'notifications-menu', title: 'Notifications menu', group: 'ui' },
    ...
    { id: 'select', title: 'Select', group: 'ui' },
...
function initDocsSidebar(activeSection) {
    ...
    function handleDocsNavigation(section) {
        ...
        const sectionToFile = {
            ...
            'notifications-menu': 'notifications-menu.html',
            ...
            'indice-progreso-estudiante': 'indice-progreso-estudiante.html',
            'paginas-creator': 'paginas-creator.html',
            'paginas-exp-estudio': 'paginas-exp-estudio.html',
            'paginas-progreso-estudiante': 'paginas-progreso-estudiante.html',
